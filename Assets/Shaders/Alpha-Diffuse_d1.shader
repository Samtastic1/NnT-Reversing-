...
SubShader { 
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Transparent" "IGNOREPROJECTOR"="True" "RenderType"="Glow11Transparent" "RenderEffect"="Glow11Transparent" }
  ZWrite Off
...
gbhcghgfheaaklkl"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Transparent" "IGNOREPROJECTOR"="True" "RenderType"="Glow11Transparent" "RenderEffect"="Glow11Transparent" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
