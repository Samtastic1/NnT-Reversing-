...
MAD R1.xy, fragment.texcoord[4], R0.w, c[4].y;
...
mov_pp r0.xyz, c0
dp3_pp r0.x, c6, r0
max_pp r0.y, r1.x, c4.x
mul r1.w, r0, r0.x
mul_pp r1.xyz, r0.y, c0
rcp r0.x, v4.w
mad r3.xy, v4, r0.x, c4.z
dp3 r0.x, v4, v4
texld r2.xyz, v1, s2
texld r0.w, r3, s3
...
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Float 0 [_Specular_Intensity]
Vector 1 [_Colour_Tint]
SetTexture 0 [_Diffuse] 2D 0
SetTexture 2 [_Specular] 2D 2
