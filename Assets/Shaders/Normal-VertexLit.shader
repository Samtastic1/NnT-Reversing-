...
SubShader { 
 ...
 Pass {
  Tags { "LIGHTMODE"="VertexLM" "RenderType"="Glow11" "RenderEffect"="Glow11" }
  BindChannels {
   Bind "vertex", Vertex
   Bind "normal", Normal
 ...
 Pass {
  Tags { "LIGHTMODE"="VertexLMRGBM" "RenderType"="Glow11" "RenderEffect"="Glow11" }
  BindChannels {
   Bind "vertex", Vertex
   Bind "normal", Normal
   Bind "texcoord1", TexCoord0
 ...
 Pass {
  Name "SHADOWCASTER"
  Tags { "LIGHTMODE"="SHADOWCASTER" "RenderType"="Glow11" "RenderEffect"="Glow11" }
  Cull Off
  Fog { Mode Off }
  Offset 1, 1
Program "vp" {
...
ibiaiadlibiaiadlibiaiadlegaobaaaaaaaaaaadoaaaaab"
 ...
 Pass {
  ...
  Tags { "LIGHTMODE"="SHADOWCOLLECTOR" "RenderType"="Glow11" "RenderEffect"="Glow11" }
  Fog { Mode Off }
Program "vp" {
SubProgram "opengl " {
