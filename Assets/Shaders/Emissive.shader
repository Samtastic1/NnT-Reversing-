...
MAD R3.xyz, R2.z, fragment.texcoord[4], R3;
RCP R2.z, R1.w;
DP3 R2.w, R3, R3;
DP3 R1.w, R2, R2;
RSQ R2.w, R2.w;
...
MUL R3.xyz, R2.w, R3;
DP3 R2.w, R2, R3;
DP3 R2.y, R2, fragment.texcoord[2];
MOV R1.w, c[5];
MUL R3.x, R1.w, c[1];
MAX R1.w, R2, c[5].z;
POW R1.w, R1.w, R3.x;
...
RSQ R1.w, R1.w;
RSQ R2.z, R2.z;
MOV R3.yzw, fragment.texcoord[2].xxyz;
MAD R3.yzw, R2.z, fragment.texcoord[4].xxyz, R3;
RCP R2.z, R1.w;
