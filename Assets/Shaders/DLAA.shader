...
void main ()
{
  ...
  tmpvar_2.w = dot ((4.0 * abs(((((texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(-1.0, -1.0) * _MainTex_TexelSize.xy))) + texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(1.0, -1.0) * _MainTex_TexelSize.xy)))) + texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(-1.0, 1.0) * _MainTex_TexelSize.xy)))) + texture2D (_MainTex, (xlv_TEXCOORD0 + _MainTex_TexelSize.xy))) - (4.0 * tmpvar_1)))).xyz, vec3(0.33, 0.33, 0.33));
...
BindCB  "$Globals" 0
"ps_4_0
eefieceddgmhgffjpdgileldcepcjflhgfhkikacabaaaaaadeadaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0

...
void main ()
{
  ...
  vec4 tmpvar_7;
  tmpvar_7 = (((2.0 * (texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(-1.5, 0.0) * _MainTex_TexelSize.xy))) + texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(1.5, 0.0) * _MainTex_TexelSize.xy))))) + (2.0 * tmpvar_2)) / 6.0);
  vec4 tmpvar_8;
  tmpvar_8 = (((2.0 * (texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, -1.5) * _MainTex_TexelSize.xy))) + texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, 1.5) * _MainTex_TexelSize.xy))))) + (2.0 * tmpvar_2)) / 6.0);
  vec4 tmpvar_9;
  tmpvar_9 = mix (mix (tmpvar_2, tmpvar_7, vec4(clamp ((((3.0 * dot ((abs(((tmpvar_5 + tmpvar_6) - (2.0 * tmpvar_2))) / 2.0).xyz, vec3(0.33, 0.33, 0.33))) - 0.1) / dot (tmpvar_7.xyz, vec3(0.33, 0.33, 0.33))), 0.0, 1.0))), tmpvar_8, vec4((clamp ((((3.0 * dot ((abs(((tmpvar_3 + tmpvar_4) - (2.0 * tmpvar_2))) / 2.0).xyz, vec3(0.33, 0.33, 0.33))) - 0.1) / dot (tmpvar_8.xyz, vec3(0.33, 0.33, 0.33))), 0.0, 1.0) * 0.5)));
  clr_1 = tmpvar_9;
  vec4 tmpvar_10;
  tmpvar_10 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(1.5, 0.0) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_11;
  tmpvar_11 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(3.5, 0.0) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_12;
  tmpvar_12 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(5.5, 0.0) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_13;
  tmpvar_13 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(7.5, 0.0) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_14;
  tmpvar_14 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(-1.5, 0.0) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_15;
  ...
  vec4 tmpvar_18;
  tmpvar_18 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, 1.5) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_19;
  tmpvar_19 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, 3.5) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_20;
  tmpvar_20 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, 5.5) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_21;
  tmpvar_21 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, 7.5) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_22;
  tmpvar_22 = texture2D (_MainTex, (xlv_TEXCOORD0 + (vec2(0.0, -1.5) * _MainTex_TexelSize.xy)));
  vec4 tmpvar_23;
  ...
  float tmpvar_26;
  tmpvar_26 = clamp (((((((((((tmpvar_10.w + tmpvar_11.w) + tmpvar_12.w) + tmpvar_13.w) + tmpvar_14.w) + tmpvar_15.w) + tmpvar_16.w) + tmpvar_17.w) / 8.0) * 2.0) - 1.0), 0.0, 1.0);
  float tmpvar_27;
  tmpvar_27 = clamp (((((((((((tmpvar_18.w + tmpvar_19.w) + tmpvar_20.w) + tmpvar_21.w) + tmpvar_22.w) + tmpvar_23.w) + tmpvar_24.w) + tmpvar_25.w) / 8.0) * 2.0) - 1.0), 0.0, 1.0);
  float tmpvar_28;
  tmpvar_28 = abs((tmpvar_26 - tmpvar_27));
  if ((tmpvar_28 > 0.2)) {
    float tmpvar_29;
    tmpvar_29 = dot (((((((((tmpvar_10 + tmpvar_11) + tmpvar_12) + tmpvar_13) + tmpvar_14) + tmpvar_15) + tmpvar_16) + tmpvar_17) / 8.0).xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_30;
    tmpvar_30 = dot (((((((((tmpvar_18 + tmpvar_19) + tmpvar_20) + tmpvar_21) + tmpvar_22) + tmpvar_23) + tmpvar_24) + tmpvar_25) / 8.0).xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_31;
    tmpvar_31 = dot (tmpvar_2.xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_32;
    tmpvar_32 = dot (tmpvar_3.xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_33;
    tmpvar_33 = dot (tmpvar_4.xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_34;
    tmpvar_34 = dot (tmpvar_5.xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_35;
    tmpvar_35 = dot (tmpvar_6.xyz, vec3(0.33, 0.33, 0.33));
    float tmpvar_36;
    if ((tmpvar_31 == tmpvar_34)) {
      tmpvar_36 = 0.0;
    } else {
      tmpvar_36 = clamp (((tmpvar_29 - tmpvar_34) / (tmpvar_31 - tmpvar_34)), 0.0, 1.0);
    };
    float tmpvar_37;
    if ((tmpvar_31 == tmpvar_35)) {
      tmpvar_37 = 0.0;
    } else {
      tmpvar_37 = clamp ((1.0 + ((tmpvar_29 - tmpvar_31) / (tmpvar_31 - tmpvar_35))), 0.0, 1.0);
    };
    float tmpvar_38;
    if ((tmpvar_31 == tmpvar_32)) {
      tmpvar_38 = 0.0;
    } else {
      tmpvar_38 = clamp (((tmpvar_30 - tmpvar_32) / (tmpvar_31 - tmpvar_32)), 0.0, 1.0);
    };
    float tmpvar_39;
    if ((tmpvar_31 == tmpvar_33)) {
      tmpvar_39 = 0.0;
    } else {
      tmpvar_39 = clamp ((1.0 + ((tmpvar_30 - tmpvar_31) / (tmpvar_31 - tmpvar_33))), 0.0, 1.0);
    };
    clr_1 = mix (mix (tmpvar_9, mix (tmpvar_4, mix (tmpvar_3, tmpvar_2, vec4(tmpvar_38)), vec4(tmpvar_39)), vec4(tmpvar_27)), mix (tmpvar_6, mix (tmpvar_5, tmpvar_2, vec4(tmpvar_36)), vec4(tmpvar_37)), vec4(tmpvar_26));
  };
  gl_FragData[0] = clr_1;
}
...
BindCB  "$Globals" 0
"ps_4_0

