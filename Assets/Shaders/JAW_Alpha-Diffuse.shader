Shader "JAW/Transparent/Diffuse" {
Properties {
...
SubShader { 
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Background+1" "IGNOREPROJECTOR"="True" "RenderType"="Transparent" }
  ZWrite Off
...
gbhcghgfheaaklkl"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Background+1" "IGNOREPROJECTOR"="True" "RenderType"="Transparent" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
