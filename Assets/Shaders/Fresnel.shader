...
Float 1 [_Glossiness]
Float 2 [_Rim_Thickness]
Float 3 [_Rim_Range]
Vector 4 [_Emissive_Colour]
...
POW R0.w, R0.w, R1.y;
MOV R1.xyz, c[6];
DP3 R1.w, R4, fragment.texcoord[3];
DP3 R1.x, R1, c[0];
MAX R1.y, R1.w, c[5].z;
MUL R1.w, R0, R1.x;
MUL R1.xyz, R1.y, c[0];
...
dp3_pp r0.x, t2, t2
rsq_pp r0.x, r0.x
mad_pp r5.xyz, r0.x, t2, r1
dp3_pp r1.x, r4, r4
dp3_pp r0.x, r5, r5
rsq_pp r1.x, r1.x
mul_pp r6.xyz, r1.x, r4
rsq_pp r0.x, r0.x
...
RSQ R2.y, R2.y;
MUL R3.xyz, R0.w, R3;
MUL R2.yzw, R2.y, fragment.texcoord[2].xxyz;
DP3 R0.w, R2.yzww, R3;
ADD R0.w, -R0, c[3].z;
POW R0.w, R0.w, c[0].x;
MUL R3.xyz, R1, R2.x;
...
def c3, 128.00000000, 0.21997070, 0.70703125, 0.07098389
dcl t0
dcl t1.xy
dcl t2.xyz
dcl t3.xyz
...
MAX R2.z, R3.x, c[2].x;
MUL R2.w, R2.x, R2.y;
SLT R3.x, c[2], fragment.texcoord[4].z;
MUL R0.w, R3.x, R0;
MUL R2.xyz, R2.z, c[0];
MUL R0.w, R0, R1;
MUL R2, R0.w, R2;
...
dcl_2d s3
dcl_2d s4
def c2, 0.00000000, 1.00000000, 0.50000000, 128.00000000
