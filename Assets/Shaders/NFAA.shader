...
void main ()
{
  ...
  gl_FragData[0] = (((((texture2D (_MainTex, tmpvar_11) + texture2D (_MainTex, (tmpvar_11 + tmpvar_10))) + texture2D (_MainTex, (tmpvar_11 - tmpvar_10))) + texture2D (_MainTex, (tmpvar_11 + tmpvar_12))) + texture2D (_MainTex, (tmpvar_11 - tmpvar_13))) * 0.2);
}
...
"vs_4_0
eefiecedfckagajkmlgejgoccopoejpoadngmmmaabaaaaaadiaeaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedjhpgeifjpjofbfgjjghkfbfcokkefhmjabaaaaaaeaaiaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0

