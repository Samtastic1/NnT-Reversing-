...
MUL R0.x, R0, R0.z;
POW R0.x, c[6].y, R0.x;
ADD result.color.w, -R0.x, c[6].x;
MOV R0.x, c[6];
ADD R0.x, R0, c[5];
KIL -R0.y;
MUL result.color.xyz, R0.x, c[3];
END
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedmajookeocepmndempbkbmkimnkiabbmjabaaaaaapmacaaaaadaaaaaa
...
abapaaaafdfgfpfegbhcghgfheaafdfgfpeegfhahegiaaklfdeieefcbmacaaaa
eaaaaaaaihaaaaaafjaaaaaeegiocaaaaaaaaaaaaeaaaaaagcbaaaaddcbabaaa
abaaaaaagfaaaaadpccabaaaaaaaaaaagiaaaaacabaaaaaaapaaaaahbcaabaaa
...

...
aaaaaaaaagaabaaaaaaaaaaaegiccaaaaaaaaaaaacaaaaaadoaaaaab"
}
}
 }
}
